  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onContinue}>
      <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "flex-end" }}>
        <View style={{ backgroundColor: "#FFFFFF", borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingBottom: 24 }}>
          {/* Header */}
          ...
          <View style={{ alignItems: "center", paddingTop: 20 }}>
            <View style={{ width: 72, height: 72, borderRadius: 36, backgroundColor: lost ? "#F3F4F6" : "#FFF2E6", alignItems: "center", justifyContent: "center" }}>
            ...
            <Text style={{ marginTop: 12, fontSize: 22, fontWeight: "700", color: "#111111" }}>
          ...
          <View style={{ marginTop: 16, marginHorizontal: 16, padding: 10, borderRadius: 12, backgroundColor: "#F9FAFB", borderWidth: 1, borderColor: "#E6E3DA" }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              {week.map((d, i) => (
                <View key={`dot-${i}`} style={{ width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: lost ? "#D1D5DB" : "#111111", backgroundColor: d.filled ? (lost ? "#D1D5DB" : "#111111") : "transparent" }} />
              ))}
            </View>
          </View>
          ...
          <View style={{ marginTop: 18, paddingHorizontal: 16 }}>
            <Pressable onPress={onContinue} style={{ backgroundColor: lost ? "transparent" : "#111111", borderWidth: lost ? 2 : 0, borderColor: "#111111", paddingVertical: 14, borderRadius: 14, alignItems: "center" }}>
